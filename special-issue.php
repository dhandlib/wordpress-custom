	...
	<div id="content" class="col9">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?>>
			...
			<div class="post-footer">
				Edited by Caitlin Christian-Lamb, Zach Coble, Thomas Padilla, Caro Pinto, Sarah Potvin, John Russell, Roxanne Shirazi, and Patrick Williams
              </div>
          
          <div class="post-footer">
				<?php the_time( 'j M Y' ); ?>
			</div>
          <div id="widgetarea-SI16" class="widgetarea-si">
